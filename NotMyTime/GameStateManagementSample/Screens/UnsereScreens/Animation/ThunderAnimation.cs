...
{
    class ThunderAnimation : GameScreen
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public ThunderAnimation(Vector2 targetPosition)
        {
            ...
            animationContainer = new Rectangle[2, 5];
            int x = 192;
            int y = 192;
            for (int i = 0; i < 2; i++)
            {
        ...
        public override void LoadContent()
        {
            ...
            animationTexture = content.Load<Texture2D>("Battle/Animations/Thunder2");
